...
public class PrintStreamCapturer extends PrintStream {
    ...
    private MainController text;
    private boolean atLineStart;
    private String indent;

    public PrintStreamCapturer(MainController text, PrintStream capturedStream, String indent) {
    ...
    public PrintStreamCapturer(MainController text, PrintStream capturedStream) {
        this(text, capturedStream, "");
    }
